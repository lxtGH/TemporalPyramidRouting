...
from cvpods.layers.batch_norm import get_activation, get_norm
from cvpods.layers.masked_conv import masked_conv2d
...
class AlignedDynamicScale(nn.Module):
    def __init__(
        self,
        in_channels : int,
        out_channels : int,
        ...
        super(AlignedDynamicScale, self).__init__()
        self.num_groups = num_groups
        self.num_adjacent_scales = num_adjacent_scales
        self.depth_module = depth_module
        dynamic_convs = [DFConv2d(
            in_channels,
            out_channels,
            kernel_size=kernel_size,
            padding=padding,
