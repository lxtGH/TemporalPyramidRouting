...
def main():
    ...
    for idx, boundary_feature_name, contraction_feature, expansion_feature, contraction_warp, expansion_warp, color_map \
        in zip(range(num_images), boundary_features, contraction_features, expansion_features, contraction_warps, expansion_warps, color_maps):
        ...
        color_map = cv2.resize(color_map, (512, 256))
        save_images = np.vstack([boundary_feature, contraction_feature, expansion_feature, contraction_warp, expansion_warp, color_map])
